...
var data = [
  ...
  },
  {
    ...
    "beliefs":[
      ...
      "The contest is Now. Your progress is wrecked or preserved by a single day and a single event.",
      "Resolve to live as a grown-up, and make whatever you think best a law you never set aside.",
      "You are not your thoughts. Control them.",
      "Decisions against our betters selves offend the soul.",
      "Attach yourself to what is spiritually superior, regardless of what other people think or do.",
      "Begin everyday by counting your blessings.",
      "It's not what happens to you, but how you react to it that matters.",
      "When faced with temptation, distract yourself with work.",
  ...
  },
  {
    ...
    "beliefs":[
      ...
      "Whoever sees himself as judge of Truth and Knowledge is shipwrecked by the laughter of the gods."
    ]
  }
];
